...
public class GererClass extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listItemAdapter = new SimpleAdapter(this.getBaseContext(), listItem, R.layout.listparameter, new String[]{"class"}, new int[]{R.id.textPara});
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
				...
				.setPositiveButton("OK", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (modify.getText().toString().trim().equals("")) 
						{
							new AlertDialog.Builder(GererClass.this)    
							                .setTitle("Warning")  
						...
						else 
						{
					        ...
					        tmp.put("class",modify.getText().toString());
							listItem.set(arg2, tmp);
							listItemAdapter.notifyDataSetChanged();
						}
						InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                        imm.hideSoftInputFromWindow(modify.getWindowToken(), 0);
					}
				})  
			...
			public void onClick(View v) {
				...
				.setPositiveButton("OK", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						{
							HashMap<String, String> tmp = new HashMap<String, String>();
					        tmp.put("class",addEditText.getText().toString());
							listItem.add(tmp);
							listItemAdapter.notifyDataSetChanged();
		...
		delete.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				.setMultiChoiceItems(it, bolIt, new OnMultiChoiceClickListener() {
